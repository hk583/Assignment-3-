...
def round(number, places):
    ...
    number_long = number *(10**places)
    ###print (str(number_long) + ' is number_long')
    number_long = number_long + 0.5
    ###print (str(number_long) + 'is number_long with 0.5 added')
    number_long = math.floor(number_long)
    ##print (str(number_long) + ' is the number_long truncated')
    number_long = (math.pow(10,(-1*places))*number_long)
    ##print (str(number_long) + ' is number_long divided')
    number_long = float(str(number_long)[:str(number_long).find('.')+places+1])
    return number_long
